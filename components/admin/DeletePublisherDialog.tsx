...
export const DeletePublisherDialog: React.FC<DeletePublisherDialogProps> = ({
  open,
  onOpenChange,
  publisher,
  onConfirm,
      ...
      >
        ...
        <div className="p-5 text-slate-700">
          <p className="text-sm leading-relaxed">
            ...
            <span className="font-bold text-slate-900">&quot;{publisher.name}&quot;</span>?
          </p>
          <p className="mt-2 text-xs text-slate-500 leading-relaxed bg-slate-50 p-3 rounded-xl border border-slate-100">
            This action cannot be undone. All data related to this publisher will be permanently removed from the system.
          </p>
        </div>
        ...
        <div className="flex items-center justify-end gap-2.5 border-t border-slate-100 bg-slate-50/50 px-5 py-3.5">
          ...
          >
            ...
            {isDeleting ? "Deleting..." : "Delete Publisher"}
          </button>
        </div>
      </DialogContent>
    </Dialog>
